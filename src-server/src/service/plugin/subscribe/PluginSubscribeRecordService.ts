import {SourceSubscribe, SourceSubscribeRecordResult} from "@/types/SourceSubscribe";
...
export async function pluginSubscribeRecordService(subscribe: SourceSubscribe): Promise<Array<SourceSubscribeRecordResult>> {
