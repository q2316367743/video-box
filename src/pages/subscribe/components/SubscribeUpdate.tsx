...
import { pluginSubscribeAdd } from "@/apis/plugin/subscribe";
import { SourceSubscribePostParam, SubscribeRssParseResult } from "@/types/SourceSubscribe";
import MessageUtil from "@/utils/modal/MessageUtil";
import { DialogPlugin, Input, Button } from "tdesign-vue-next";
import styles from "../discover/dialog/SubscribeDiscoverDialog.module.css";
...
export function openSubscribeUpdateDialog(row: SourceSubscribe, onUpdate: () => void) {
  ...
  const dp = DialogPlugin({
    ...
    default: () => <div class={styles['subscribe-dialog']}>
      {/* RSS 源信息展示 */}
